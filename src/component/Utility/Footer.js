...
import facebook from "../../imeges/facebook.png";
import instagram from "../../imeges/instagram.png";
import twitter from "../../imeges/twitter.png";
import phone from "../../imeges/phone.png";
const Footer = () => {
    return (
                ...
                <Row className="d-flex justify-content-between align-items-center">
                    ...
                    <Col
                        ...
                        <div className="d-flex pt-3 mx-2">
                            ...
                            <p className="footer-phone">01143573704</p>
                        </div>
